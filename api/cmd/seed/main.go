...
var (
	...
	dir   = flags.String("dir", "./seed", "directory with migration files")
	noVer = flags.Bool("no-versioning", true, "disable versioning")
)
...
func main() {
	...
	if err := goose.RunWithOptionsContext(ctx, command, db, *dir, arguments, goose.WithNoVersioning()); err != nil {
