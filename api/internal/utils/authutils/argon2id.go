//nolint:nonamedreturns,gochecknoglobals,mnd//whatever
package authutils
...
var PreventBruteForceAndTimingAttacksParams = &Params{
	Memory:      1024,
	Iterations:  8,
	Parallelism: uint8(runtime.NumCPU()),
	SaltLength:  16,
...
// should).
func CheckHash(password, hash string) (bool, *Params, error) {
	params, salt, key, err := DecodeHash(hash)
	if err != nil {
		return false, nil, err
	}

	otherKey := argon2.IDKey([]byte(password),
